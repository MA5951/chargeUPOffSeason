...
public class IntakeConstance {    
    public static final double currentAmpThreshold = 23;

    public static final double IntakePowerForCube = -0.5;
    public static final double IntakePowerForCone = 0.8;

    public static final double EjectPowerForCube = 0.5;
    public static final double EjectPowerForCubeForLow = 0.8;
    public static final double EjectPowerForCone = -0.8;

    public static final double ejectTime = 0.8;
