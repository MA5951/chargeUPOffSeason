...
public class IntakeConstance {    
    public static final double currentAmpThreshold = 37; // in amps TODO

    public static final double IntakePowerForCube = 0.8; // TODO
    public static final double IntakePowerForCone = -0.8; // TODO

    public static final double EjectPowerForCube = -0.5; // TODO
